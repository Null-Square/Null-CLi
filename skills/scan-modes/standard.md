---
slug: scan-mode-standard
name: Standard scoped assessment
description: Slightly broader public workflow for authorized web or code targets.
category: scan-mode
---

Use this mode for a repeatable open-source assessment.

Recommended flow:

1. Record the declared scope and assumptions.
2. Gather HTTP metadata and page structure.
